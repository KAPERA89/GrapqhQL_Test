...
public class InventoryServiceApplication {
    ...
    public CommandLineRunner start(CreatorRepository creatorRepository, VideoRepository videoRepository){
        return args -> {
          ...
          Creator c = Creator.builder().name("Othmane").email("othmanedarhoni@gmail.com").build();
          Creator c2 = Creator.builder().name("Othmane2").email("othmane2darhoni@gmail.com").build();
          Creator c3 = Creator.builder().name("Othmane3").email("othmane3darhoni@gmail.com").build();
